...
uv run python scripts/build_comprehensive_kwic_dataset.py -i data/stimuli.csv -o /pvc/SemShift/output.csv -j /pvc/SemShift/output.json --checkpoint-dir /pvc/SemShift/checkpoints --checkpoint-freq 10 --verbs ""
